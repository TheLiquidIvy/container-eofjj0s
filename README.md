...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-eofjj0s.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-eofjj0s.containers.anotherwebservice.com/
...
```
git clone git@github.com:TheLiquidIvy/container-eofjj0s.git
cd container-eofjj0s
```
...
```
docker attach container-eofjj0s
```
